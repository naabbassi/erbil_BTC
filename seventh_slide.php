	...
	<div class="main seventh_slide" id="seventh_slide">
		<h1 class="progress_title">Construction<br/>&nbsp; Progress</h1>
				...
				<?php 
					...
					foreach ($res as $key) { $deg=rand(-7,7); ?>
						<div class="ps_album" style="opacity:0;-webkit-transform:rotate(<?php echo $deg ?>deg);transform:rotate(<?php echo $deg ?>);">
							...
							<p><?php echo $key->english_title ?></p>
						</div>
					<?php }
				?>
			</div>	
		...
		<a href="#fifth_slide" class="arrow up_arrow" id="goto"><p class="arrow_box_left">Project features</p></a>
		<a href="#eighth_slide" class="arrow down_arrow" id="goto"><p class="arrow_box_left">Downloads</p></a>
